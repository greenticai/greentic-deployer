...
- the pack input contract is now explicitly cloud-aware via `cloud = aws|azure|gcp`
- the fixture compute/runtime module is still AWS-oriented today
- canonical secret-reference output names are already frozen for future Azure/GCP parity
